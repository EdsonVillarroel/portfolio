        ...
        <div className="row">
          ...
          <div className="container-presentaion">
            ...
            <p className="content-presentacion">
              ...
              desafíos para ampliar mis habilidades. Actualmente estoy enfocado
              en proyectos de desarrollo web, trabajando en aplicaciones de alta
              ...
              emocionado de seguir creciendo y aprendiendo como desarrollador
              web. ¡Estoy abierto a nuevas oportunidades y espero poder hacer
              una contribución positiva en futuros proyectos!
            </p>
          </div>
        </div>
      </div>
